...
Copy from https://github.com/lucidrains/vector-quantize-pytorch/blob/master/vector_quantize_pytorch/lookup_free_quantization.py
"""
...
#     quantizer = LFQ(
#         codebook_size=8,  # codebook size, must be a power of 2
#         dim=3,  # this is the input feature dimension, defaults to log2(codebook_size) if not defined
#         entropy_loss_weight=0.1,  # how much weight to place on entropy loss
#         diversity_gamma=1.
#         # within entropy loss, how much weight to give to diversity of codes, taken from https://arxiv.org/abs/1911.05894
#     )
#
#     image_feats = torch.randn(1, 3, 32, 32)
#
#     quantized, indices, entropy_aux_loss = quantizer(image_feats,
#                                                      inv_temperature=100.)  # you may want to experiment with temperature
#
#     print(quantized.shape)  ## torch.Size([1, 3, 32, 32])
#     print(indices.shape)  ## torch.Size([1, 32, 32])
#     print(entropy_aux_loss) ## tensor(-0.2067)
#
